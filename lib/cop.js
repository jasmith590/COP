...
exports.load = function (filename, input) {
    ...
    if (input) {
        ...
        inputformat = fileExt.getFileExtension(filename);
    }
...
exports.fileList = function(dir, testCase) {
    return fs.readdirSync(dir).reduce((list, file) => {
        ...
        let ext = fileExt.getFileExtension(file);
 ...
 */
exports.templateEngines = template.templateEngines;
