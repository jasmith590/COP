...
exports.convert = function (obj, ret, outerParent) {
    ...
    switch (type) {
        case 'array':
            ...
            break;
        case 'hash':
            this.convertHash(obj, ret, outerParent);
            break;
        case 'string':
...
exports.convertHash = function (obj, ret, outerParent) {
    var configPrefix = helpers.getConfigPrefix();
    var prefix = (typeof configPrefix !== "undefined" && outerParent) ? configPrefix : "";
    ...
    for (var k in obj) {
        ...
        if (type == 'string' || type == 'null' || type == 'number' || type == 'boolean') {
            ret.push(prefix + this.normalizeString(k) + ': ' + recurse[0]);
        } else {
            ret.push(prefix + this.normalizeString(k) + ': ');
